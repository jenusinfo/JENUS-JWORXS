...
const SubmitModal = ({ isOpen, handleClose }: {
    ...
    const { step, setStep, handleSaveFlow } = useInterview()
        ...
        <Modal isOpen={isOpen} handleClose={handleClose} width={695}>
            <div className="py-[60px]">
                ...
                <div className="flex justify-center gap-2 mt-10">
                    <button className="text-[#2454de] bg-[#eef0fe] rounded-[4px] px-6 py-2.5 h-fit text-sm" onClick={handleSaveFlow}>Save & Close</button>
