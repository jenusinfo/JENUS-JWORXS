        ...
        <div className="w-screen h-[calc(100vh-57px)] flex justify-center items-center">
            <div className="w-[480px] flex flex-col gap-4">
                ...
                <div className="flex justify-center gap-4">
                    <button className="text-[#2454de] bg-[#eef0fe] rounded-[4px] px-6 py-2.5 h-fit text-sm" onClick={() => setStep(step-1)}>Close</button>
                    <button className="text-white bg-[#2454de] rounded-[4px] px-5 py-2.5 h-fit text-sm" onClick={() => setStep(1)}>Review</button>
                </div>
            </div>
        </div>
    )
...
export default WorkitemSubmited