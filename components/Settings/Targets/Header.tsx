...
const TargetsHeader = () => {
    ...
    const { setCurIndex, setInfo, targets: data, search, setSearch } = useTargets()
    const [isOpen, setIsOpen] = useState(false)

    return (
        <div className="flex justify-between border-b border-[#DEDFEA] pb-2">
            <div className="flex flex-col gap-3">
                <Text text="Targets" size={28} weight="700" />
            ...
            <div className="flex gap-2">
                ...
                <CSVLink filename="Jdocs-targets" data={data} className="text-[#2454de] bg-[#eef0fe] rounded-[4px] px-6 py-2.5 h-fit hover:bg-blue-100 transition-all duration-400">Export As</CSVLink>
