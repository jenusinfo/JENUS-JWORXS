    ...
    return (
        <div className="flex justify-between border-b border-[#DEDFEA] pb-2">
            ...
            <div className="flex gap-2">
                ...
                <CSVLink filename="Jdocs-email-templates" data={data} className="text-[#2454de] bg-[#eef0fe] rounded-[4px] px-6 py-2.5 h-fit hover:bg-blue-100 transition-all duration-400">Export As</CSVLink>
